...
const translations = {
  no: {
    ...
    metaDescription:
      "Oversikt over hobbyappene Bananmatte og FactHunter. Alt lagres på telefonen. Bruk på eget ansvar.",
    ...
    appsTitle: "Appene",
    appsIntro:
      "To apper så langt. Begge åpnes i nettleseren og kan legges på hjemskjermen. Ingen appbutikk, ingen konto.",
    ...
    madeBody:
      "Enkle webapper (PWA) som kjører i nettleseren og kan installeres på hjemskjermen. De er bygget med Vite og TypeScript og ligger på GitHub Pages. Ingen egen server, ingen innlogging. Bananmatte lagrer innstillinger og rekorder i localStorage. FactHunter lagrer samlingen i IndexedDB. FactHunter henter lesende oppslag fra Wikipedia; ingenting sendes til meg.",
  ...
  en: {
    ...
    metaDescription:
      "A portal to the hobby apps Bananmatte and FactHunter. Everything stays on your phone. Use at your own risk.",
    ...
    appsTitle: "The apps",
    appsIntro:
      "Two so far. Both open in the browser and can be added to your home screen. No app store, no account.",
    "bananmatte.name": "Bananmatte",
    ...
    madeBody:
      "Simple web apps (PWAs) that run in the browser and can be installed on the home screen. They are built with Vite and TypeScript and hosted on GitHub Pages. No server of my own, no login. Bananmatte keeps settings and high scores in localStorage. FactHunter keeps the collection in IndexedDB. FactHunter only reads from Wikipedia; nothing is sent to me.",
  ...
  de: {
    metaTitle: "Reidar Kind — Hobby-Apps",
    metaDescription:
      "Überblick über die Hobby-Apps Bananmatte und FactHunter. Alles bleibt auf dem Telefon. Nutzung auf eigene Gefahr.",
    ...
    appsTitle: "Die Apps",
    appsIntro:
      "Zwei bisher. Beide öffnen sich im Browser und können auf den Startbildschirm. Kein App-Store, kein Konto.",
    "bananmatte.name": "Bananmatte",
  ...
  es: {
    ...
    metaDescription:
      "Portal de las apps de hobby Bananmatte y FactHunter. Todo se guarda en el teléfono. Úsalas bajo tu responsabilidad.",
    ...
    appsTitle: "Las apps",
    appsIntro:
      "Dos por ahora. Las dos se abren en el navegador y se pueden añadir a la pantalla de inicio. Sin tienda, sin cuenta.",
    "bananmatte.name": "Bananmatte",
  ...
  pt: {
    metaTitle: "Reidar Kind — apps de hobby",
    metaDescription:
      "Portal das apps de hobby Bananmatte e FactHunter. Tudo fica no telemóvel. Use por sua conta e risco.",
    ...
    appsTitle: "As apps",
    appsIntro:
      "Duas por agora. Ambas abrem no browser e podem ir para o ecrã inicial. Sem loja, sem conta.",
    "bananmatte.name": "Bananmatte",
