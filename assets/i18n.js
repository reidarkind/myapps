...
const translations = {
  no: {
    ...
    "storealfabet.devices": "Telefon · kun norsk",
    "storealfabet.lead": "Alf har forsovet seg!",
    "storealfabet.body":
      "Bokstavspill for 1. og 2. klasse. Du hjelper hunden Alf til skolen, øver på bokstaver, lyder, rim og små ord, samler krystaller og diamanter, og unngår tullete bokstavzombier. Målet er å rekke skolen og kjøpe skolemelk. Rekorder blir på telefonen. Appen er bare på norsk.",
  ...
  en: {
    ...
    "storealfabet.name": "StoreAlfabet",
    "storealfabet.devices": "Phones · Norwegian only",
    "storealfabet.lead": "Alf overslept!",
    "storealfabet.body":
      "A letter game for years 1 and 2. You help the dog Alf get to school, practise letters, sounds, rhymes and small words, collect crystals and diamonds, and dodge silly letter zombies. The goal is to reach school and buy school milk. Records stay on the phone. The app is in Norwegian only.",
  ...
  de: {
    ...
    "storealfabet.name": "StoreAlfabet",
    "storealfabet.devices": "Telefone · nur Norwegisch",
    "storealfabet.lead": "Alf hat verschlafen!",
    "storealfabet.body":
      "Buchstabenspiel für die 1. und 2. Klasse. Du hilfst dem Hund Alf zur Schule, übst Buchstaben, Laute, Reime und kleine Wörter, sammelst Kristalle und Diamanten und weichst albernen Buchstaben-Zombies aus. Ziel ist die Schule und die Schulmilch. Rekorde bleiben auf dem Telefon. Die App gibt es nur auf Norwegisch.",
  ...
  es: {
    ...
    "storealfabet.name": "StoreAlfabet",
    "storealfabet.devices": "Teléfonos · solo en noruego",
    "storealfabet.lead": "¡Alf se ha quedado dormido!",
    "storealfabet.body":
      "Juego de letras para 1.º y 2.º. Ayudas al perro Alf a llegar al cole, practicas letras, sonidos, rimas y palabras cortas, recoges cristales y diamantes y esquivas zombis de letras un poco tontos. El objetivo es llegar y comprar la leche escolar. Los récords se quedan en el teléfono. La app está solo en noruego.",
  ...
  pt: {
    ...
    "bananmatte.cta": "Abrir Bananmatte",
    "storealfabet.name": "StoreAlfabet",
    "storealfabet.devices": "Telemóveis · só em norueguês",
    "storealfabet.lead": "O Alf dormiu a mais!",
    "storealfabet.body":
      "Jogo de letras para o 1.º e 2.º ano. Ajudas o cão Alf a chegar à escola, treinas letras, sons, rimas e palavras pequenas, apanhas cristais e diamantes e evitas zombies de letras um pouco parvos. O objetivo é chegar e comprar leite escolar. Os recordes ficam no telemóvel. A app está só em norueguês.",
    "storealfabet.cta": "Abrir StoreAlfabet",
    "facthunter.name": "FactHunter",
